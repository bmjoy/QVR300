...
namespace Svr
{
    ...
    bool InitializeRenderExtensions()
    {
        ...
        // glEGLImageTargetTexture2DOES = (PFNGLEGLIMAGETARGETTEXTURE2DOESPROC)InitExtension("glEGLImageTargetTexture2DOES");
#endif //ENABLE_MOTION_VECTORS
        eglGetNativeClientBufferANDROID = (PFNEGLGETNATIVECLIENTBUFFERANDROIDPROC)InitExtension("eglGetNativeClientBufferANDROID");
        LOGI("svrRenderExt.cpp InitializeRenderExtensions done eglGetNativeClientBufferANDROID=%p, eglCreateImageKHR=%p",
