...
namespace Svr
{
                               ...
                               float ipd, float headHeight, float headDepth, glm::mat4& outLeftEyeMatrix, glm::mat4& outRightEyeMatrix)
    {
        ...
        poseMat = glm::translate(poseMat, glm::vec3(headOffset));
        glm::mat4 leftEyeOffsetMat = glm::translate(glm::mat4(1.0f),
                                                    glm::vec3((0.5f * ipd), 0, 0));
        glm::mat4 rightEyeOffsetMat = glm::translate(glm::mat4(1.0f),
                                                     glm::vec3((-0.5f * ipd), 0, 0));
        glm::mat4 headRotateLeftY = glm::rotate(glm::mat4(1), glm::radians(poseState.headRotateLeftY), glm::vec3(0, 1, 0));
        glm::mat4 headRotateRightY = glm::rotate(glm::mat4(1), glm::radians(poseState.headRotateRightY), glm::vec3(0, 1, 0));
        outLeftEyeMatrix = headRotateLeftY * leftEyeOffsetMat * poseMat;
        outRightEyeMatrix = headRotateRightY * rightEyeOffsetMat * poseMat;
